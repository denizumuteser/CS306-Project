...
<body>
  ...
  <div class="content">
    <h2>Display Club Members</h2>

    <Form id="features-form" action="club_members.php" method="post">
      <fieldset id="fieldsetInputs">

        <label for="fclub_id">Club ID:</label>
        <select name="fclub_id" , id="fclub_id">
          <?php
          include "config.php";

          $sql_statement = "SELECT club_id FROM club ORDER BY club_id ASC";
